        ...
        <form action="{{ route('doctor.checkups.store') }}" method="POST" x-data="checkupForm()">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                ...
                                <select name="patient_id" id="patient_id" required
                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base shadow-sm border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="bp" id="bp" placeholder="120/80"
                                    class="mt-1 shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                @error('bp')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea name="visit_history" id="history" rows="3"
                                    class="mt-1 shadow-sm focus:ring-blue-500 p-2 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
                                @error('history')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-2">
                                ...
                                <div class="col-span-6 sm:col-span-1">
                                    ...
                                    <input type="number" x-model="med.quantity" :name="'medications['+index+'][quantity]'"
                                        @change="calculateTotals()"
                                          class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full border p-2 sm:text-sm border-gray-300 rounded-md">
                                    @error('medications.*.quantity')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-span-6 sm:col-span-2">
                                    ...
                                    <input type="text" x-model="med.dosage" :name="'medications['+index+'][dosage]'"
                                        class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full border p-2 sm:text-sm border-gray-300 rounded-md">
                                    @error('medications.*.dosage')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-span-6 sm:col-span-1">
                                    <button type="button" @click="removeMedication(index)"
                                        class="mt-5 inline-flex items-center px-3 py-2 border text-red-500 border-transparent text-sm">
                        ...
                        <div class="text-right">
                            <span class="text-base">Total Medications: $<span x-text="medicationsTotal"></span></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-2">
                            ...
                            <div class="grid grid-cols-6 gap-6 mb-4">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select x-model="prod.product_id" :name="'products['+index+'][product_id]'"
                                        class="mt-1 block w-full pl-3 pr-10 py-2 border text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                ...
                                <div class="col-span-6 sm:col-span-1">
                                    <button type="button" @click="removeProduct(index)"
                                        class="mt-5 inline-flex items-center px-3 py-2 text-red-500 border border-transparent text-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                          </svg>
                                    </button>
                        ...
                        <div class="text-right">
                            <span class="text-base">Total Products: $<span x-text="productsTotal"></span></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    ...
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <textarea name="additional_comments" id="comments" rows="4"
                            class="shadow-sm focus:ring-blue-500 p-2 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md"></textarea>
                    </div>
                </div>
            </div>
            ...
            <input type="hidden" name="medications_total" x-model="medicationsTotal">
            <input type="hidden" name="products_total" x-model="productsTotal">
