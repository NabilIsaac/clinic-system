                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                ...
                                                @if($appointment->status === 'scheduled')
                                                    <a href="" class="ml-4 text-green-600 hover:text-green-900">Record Vitals</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                            <a href="" class="block w-full text-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">
                                Record Patient Vitals
                            </a>
                            <a href="" class="block w-full text-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700">
                                Administer Medication
                            </a>
                            <a href="" class="block w-full text-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700">
                                View Patient List
                            </a>
                        </div>
                    </div>
